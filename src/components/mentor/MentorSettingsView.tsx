            ...
            <div className="divide-y divide-[#E6E6E6] border-t border-[#E6E6E6]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 py-6">
                <div>
                  ...
                  <p className="text-[11px] text-[#808080] mt-0.5">Allow VORA to match assessment-referred candidates</p>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    <ToggleSwitch checked={voraMatchingEnabled} onChange={setVoraMatchingEnabled} />
                    <span className="text-xs text-[#1A1A1A] font-semibold">Accept VORA-matched candidates (assessment referred)</span>
                  </div>
