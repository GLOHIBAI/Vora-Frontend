...
export const SAMPLE_TALENTS = [
  { id: 'APP-VORA-001', name: 'APP-VORA-001', academicLevel: 'Postgraduate', location: 'Lagos, Nigeria', course: 'Epidemiology', dateApplied: 'Jan 16, 2025', status: 'Pending review', psych: 91, sjt: 88, video: 87, overall: 89, videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4' },
  { id: 'APP-VORA-002', name: 'APP-VORA-002', academicLevel: 'Graduate', location: 'Nairobi, Kenya', course: 'Public Health', dateApplied: 'Jan 17, 2025', status: 'Under review', psych: 85, sjt: 92, video: 83, overall: 87, videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4' },
  { id: 'APP-VORA-003', name: 'APP-VORA-003', academicLevel: 'Postgraduate', location: 'Accra, Ghana', course: 'Epidemiology', dateApplied: 'Jan 18, 2025', status: 'Hired', psych: 88, sjt: 86, video: 90, overall: 88, videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4' },
  { id: 'APP-VORA-004', name: 'APP-VORA-004', academicLevel: 'Postgraduate', location: 'Cape Town, South Africa', course: 'Medicine', dateApplied: 'Jan 19, 2025', status: 'Rejected', psych: 72, sjt: 65, video: null, overall: 68, failedAt: 'Situational Judgement', rec: 'mentorship' },
  { id: 'APP-VORA-005', name: 'APP-VORA-005', academicLevel: 'Graduate', location: 'Kampala, Uganda', course: 'Public Health', dateApplied: 'Jan 20, 2025', status: 'Rejected', psych: 55, sjt: null, video: null, overall: 55, failedAt: 'Psychometric', rec: 'course' },
  { id: 'APP-VORA-006', name: 'APP-VORA-006', academicLevel: 'Postgraduate', location: 'Dar es Salaam, Tanzania', course: 'Epidemiology', dateApplied: 'Jan 21, 2025', status: 'Pending review', psych: 83, sjt: 81, video: 85, overall: 83, videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4' },
  { id: 'APP-VORA-007', name: 'APP-VORA-007', academicLevel: 'Graduate', location: 'Kigali, Rwanda', course: 'Nursing', dateApplied: 'Jan 22, 2025', status: 'Rejected', psych: 79, sjt: 80, video: null, overall: 60, failedAt: 'Video Test', rec: 'both' },
  { id: 'APP-VORA-008', name: 'APP-VORA-008', academicLevel: 'Postgraduate', location: 'Addis Ababa, Ethiopia', course: 'Epidemiology', dateApplied: 'Jan 23, 2025', status: 'Under review', psych: 94, sjt: 90, video: 92, overall: 92, videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4' },
];
...
export const SAMPLE_TALENT_PROFILE = {
  ...
  skills: [
    { label: 'Research Analysis', variant: 'blue' as const },
    { label: 'Research Analysis', variant: 'green' as const },
    { label: 'Research Analysis', variant: 'green-light' as const },
    { label: 'Research Analysis', variant: 'red' as const },
    { label: 'Research Analysis', variant: 'gray' as const }
  ],
  experience: [
    {
