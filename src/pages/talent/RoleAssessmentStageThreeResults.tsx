...
const RoleAssessmentStageThreeResults: React.FC = () => {
  ...
  const stages: Array<{ gate: number; label: string; score: number; status: string }> = vData?.stages || [
    ...
    { gate: 3, label: 'Stage 3 · How you show up', score: stageScore, status: 'passed' },
  ];
