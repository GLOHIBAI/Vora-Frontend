      ...
      <main className="max-w-[820px] mx-auto px-4 sm:px-[28px] pt-8 sm:pt-[32px] pb-[110px]">
        ...
        <div className="bg-white border border-[#0047CC]/30 rounded-[14px] p-[20px_22px] mt-[8px] mb-[8px]">
          ...
          <div className="flex gap-[11px] items-start py-[10px] border-t border-[#0047CC]/10">
            ...
            <div className="text-[13px] text-[#182348] leading-[1.55] flex-1">
              I consent to my submissions being used by VORA and {companyName} <strong className="font-[800]">solely to shape and conduct my interviews for this role</strong>. Files are encrypted and not shared beyond this hiring loop.
            </div>
          </div>
