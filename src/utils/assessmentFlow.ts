import type { AssessmentItem, ResponsesMap } from '../services/queries/assessments/types';
...
export const GATE1_SESSION1_FLOW: readonly Gate1ScreenKey[] = GATE1_SESSION1_SCREENS;

/** Session 2 — five separate POST start / POST submit cycles. */
export const GATE1_SESSION2_FLOW: readonly Gate1ScreenKey[] = GATE1_SESSION2_SCREENS;
...
export const isGate1JourneyScreenKey = (screenKey: string): screenKey is Gate1ScreenKey =>
...
export const resolveGate1PostSubmitRoute = (
  ...
  const finishedSession1 =
    finishedScreenKey === GATE1_SESSION1_SCREENS[GATE1_SESSION1_SCREENS.length - 1];
...
export const buildGate1StartBody = (screenKey: Gate1ScreenKey): { screen: Gate1ScreenKey } => ({
  screen: screenKey,
});
